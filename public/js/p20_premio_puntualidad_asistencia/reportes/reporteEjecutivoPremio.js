...
btnBuscar.click(function (e) {
    ...
    if ( formReporteEjecutivoPremio.valid() ) {
...
btnDescargar.click(function (e) {
    ...
    if ( formReporteEjecutivoPremio.valid() ) {
        ...
        $.ajax({
            type: 'GET',
            url: urlDescargarReporteEjecutivo+'/'+fechaInicio+'/'+fechaFinal,
            xhrFields: {
...
var validator = formReporteEjecutivoPremio.validate({
    onfocusout: false,
    rules: {
        fecha_inicio: {
            required: true,
