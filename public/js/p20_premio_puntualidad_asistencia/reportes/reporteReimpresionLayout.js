...
const formReporteReimpresionLayout = $( "#reporte_reimpresion_layout" );
const tablaPremio = $("#tabla_premio_reimpresion");
...
btnBuscar.click(function (e) {
    ...
    if ( formReporteReimpresionLayout.valid() ) {
        ...
        $.ajax({
            type: "POST",
            url: urlReporteReimpresionLayoutBuscar,
            data: {folio},
...
btnDescargar.click(function (e) {
    ...
    if ( formReporteReimpresionLayout.valid() ) {
        ...
        $.ajax({
            type: 'GET',
            url: urlReimpresionLayout+'/'+folio,
            xhrFields: {
