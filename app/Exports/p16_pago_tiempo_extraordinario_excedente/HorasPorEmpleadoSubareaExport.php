...
class HorasPorEmpleadoSubareaExport extends DefaultValueBinder implements FromCollection,
ShouldAutoSize,
...
WithEvents
{
    ...
    public function map($prestadores): array {
        $dataRow = [
            ...
            $prestadores->unidad_administrativa_nombre,
            $prestadores->nivel_salarial,
            $prestadores->monto_bruto,
            // $prestadores->nombre_sub_area->nombre,
            $prestadores->rfc,
