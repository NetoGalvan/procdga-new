...
class LayoutConNombres extends DefaultValueBinder implements FromCollection,
    ShouldAutoSize,
    ...
    public function __construct($empleados) {
        $this->empleados = collect($empleados);
    }
    ...
    public function map($empleado): array {
        $dataRow = [
            ...
            $empleado->areaPremio->area->identificador . " - " . $empleado->areaPremio->area->nombre,
