...
class HistoricoP20SubprocesoNomina extends Model
{
    protected $connection = "lbpm_dga";
    protected $table = "p20_subproc";
    protected $appends = ['p20_subproceso_id'];    // Estos son los campos de la nueva base, se ponen aquí los campos que no se llamen igual que en la vieja


    public function getCandidatosPremioIdAttribute()
    {
        return $this->id_p20_subproc;   // Este es el id de la tabla de la base vieja, hay que indicar como se llama
    }
