...
@section('contenido')
    ...
    @endif            
    <form id="formFinalizarBajas" action="{{ route('movimiento.personal.bajas.procesamiento.sun', [$movimientoPersonal, $instanciaTarea]) }}" method="POST">
        @csrf
        @method('post')
...
@push('scripts')	
    <script src="{{ asset("js/p01_movimientos_personal/tareas/TB03_finalizacionMovimientoBajas.js?v=1.1") }}"></script> 
@endpush
