...
@section('title', 'Niveles Salariales - Crear')
...
@section('contenido')
    <div class="card card-custom">
        ...
        <form method="POST" action="{{ route('niveles-salariales.store') }}" id="form_guardar_nivel_salarial">
            @method('post')
            @csrf
            <div class="card-body">
            ...
            <div class="card-footer">
                <button type="button" id="btn_guardar_nivel_salarial" class="btn btn-secondary mr-4 btn-submit" data-type="agregar">
