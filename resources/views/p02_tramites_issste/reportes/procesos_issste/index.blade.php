...
@section('contenido')
    <form id="form_buscar" action="{{ route('tramites.issste.reporte.procesos.buscar') }}">
                ...
                <table
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-field="created_at"><label class="titulo-dato">Fecha creación</label></th>
                        </tr>
                    </thead>
                </table>
            </div>
...
@push('scripts')
    ...
    <script src="{{ asset('js/p02_tramites_issste/reportes/procesos_issste/index.js?v=1.8') }}"></script>
@endpush