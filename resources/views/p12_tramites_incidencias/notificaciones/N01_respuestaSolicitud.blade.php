...
@section('contenido')
    <form method="POST" id="form_finalizar_tarea" action="{{ route("tramite.incidencia.respuesta.solicitud", [$tramiteIncidencia, $instanciaTarea]) }}">
        @csrf
        <div class="card card-custom">
            ...
            <div class="card-body">
                @include("p12_tramites_incidencias.partials.datos_general", [
                    "secciones" => ["general", "captura", "empleado", "jefe", "observaciones", "incidencia", "respuesta"]
                ])                
            </div>
...
@push('scripts')
    ...
    <script src="{{ asset('js/p12_tramites_incidencias/notificaciones/N01_respuestaSolicitud.js') }}"></script>
    <script>
