...
@section('contenido')
    <form method="POST" id="form_finalizar_tarea" action="{{ route("tramite.incidencia.grupal.autorizar", [$tramiteIncidencia, $instanciaTarea]) }}">
        @csrf
        <div class="card card-custom">
            ...
            <div class="card-body">
                @include("p12_tramites_incidencias.partials.datos_general_incidencia_grupal", [
                    "secciones" => ["general", "tipo_captura", "incidencia", "empleados"]
                ])
            </div>
        </div>
        <div class="card card-custom mt-8">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">Autorizar o rechazar la solicitud</h3>
                </div>
            </div>
            <div class="card-body">
                <div class="alert alert-custom alert-success" role="alert">
                    ...
                    <div class="alert-text">
                        <strong>
                            ...
                            <ul class="mb-0">
                                <li>Si desea autorizar la solicitud, seleccione "AUTORIZAR".</li>
                ...
                <div class="row">
                    <div class="col-md-4 form-group">
                        <label class="titulo-dato"><strong><span class="text-danger">* </span>Autorizar o rechazar:</strong></label>
...
@push('scripts')
    ...
    <script src="{{ asset('js/p12_tramites_incidencias/tareas/incidencia_grupal/T04_autorizarIncidencia.js?v=1.0') }}"></script>
@endpush