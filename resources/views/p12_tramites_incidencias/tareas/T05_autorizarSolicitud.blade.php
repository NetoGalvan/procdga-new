...
@section('contenido')
    <form method="POST" id="form_finalizar_tarea" action="{{ route("tramite.incidencia.autorizar.solicitud", [$tramiteIncidencia, $instanciaTarea]) }}">
        @csrf
...
@push('scripts')
    ...
    <script src="{{ asset('js/p12_tramites_incidencias/tareas/T05_autorizarIncidencia.js?v=1.0') }}"></script>
    <script>
