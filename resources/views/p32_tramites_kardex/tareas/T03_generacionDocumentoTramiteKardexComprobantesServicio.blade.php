...
@section('contenido')
            ...
            <div class="card-body" >
                    ...
                    <div class="form-group col-md-12">
                        <div class="table-responsive">
                            <table id="table_detalles" class="text-center" data-toggle="table" data-toolbar="#toolbar">
                                <thead>
                                    <tr>
                                        <th data-field="detalle_id" data-width="50"><label class="titulo-dato">Id</label></th>
                                        <th data-field="fecha_detalle_inicio" data-width="200"><label class="titulo-dato">Fecha inicio</label></th>
                                        <th data-field="fecha_detalle_termino" data-width="200"><label class="titulo-dato">Fecha termino</label></th>
                                        <th data-field="comentario"><label class="titulo-dato">Comentario</label></th>
                ...
                <div class="row">
                    <div class="col-md-4 form-group">
                        <label for="fecha_detalle_inicio" class="titulo-dato"><span class="requeridos">* </span> <b> Fecha inicio </b> </label>
                        <input type="text" class="form-control date-general-anterior" name="fecha_detalle_inicio" id="fecha_detalle_inicio" autocomplete="off" placeholder="(dd-mm-yyyy)" required>
                    </div>
                    <div class="col-md-4 form-group">
                        <label for="fecha_detalle_termino" class="titulo-dato"><span class="requeridos">* </span> <b> Fecha termino</b> </label>
                        <input type="text" class="form-control date-general-anterior" name="fecha_detalle_termino" id="fecha_detalle_termino" autocomplete="off" placeholder="(dd-mm-yyyy)" required>
                    </div>
                    <div class="col-md-4 form-group">
                        <label for="comentario" class="titulo-dato">Comentario</label>
                        <textarea rows="2" class="form-control normalizar-texto" name="comentario" id="comentario" required campoNoVacio="true"></textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-12 text-center">
    ...
    {{-- Inicio Form Final --}}
    <form method="POST" id="id_form_generacion_documento_kardex" action="{{ route('tramites.kardex.generacion.documento.comprobantes.servicio', [$tramiteKardex, $instanciaTarea]) }}">
        @method('post')
        @csrf
        ...
        <div class="card card-custom mb-5">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">Información adicional</h3>
                </div>
            </div>
            <div class="card-body" >
                <div class="row">
                    <div class="col-md-4 form-group">
                        <label for="tramite" class="titulo-dato"><span class="requeridos">* </span> <b> Trámite </b> </label>
                        <input type="text" class="form-control normalizar-texto" name="tramite" id="tramite" placeholder="Ingresa trámite" required campoNoVacio="true" />
                    </div>
                    <div class="col-md-4 form-group">
                        <label for="unidad_administrativa_nombre" class="titulo-dato"><span class="requeridos">* </span> <b> Área </b> </label>
                        <input type="text" class="form-control normalizar-texto" name="unidad_administrativa_nombre" id="unidad_administrativa_nombre" value="{{$tramiteKardex->unidad_administrativa_nombre}}" placeholder="Ingresa área" required campoNoVacio="true" />
                    </div>
                    <div class="col-md-4 form-group">
                        <label for="puesto" class="titulo-dato"><span class="requeridos">* </span> <b> Puesto </b> </label>
                        <input type="text" class="form-control normalizar-texto" name="puesto" id="puesto" value="{{$tramiteKardex->puesto}}" placeholder="Ingresa puesto" required campoNoVacio="true" />
                    </div>
                    <div class="col-md-4 form-group">
                        <label for="sueldo_base" class="titulo-dato"><span class="requeridos">* </span> <b> Sueldo base </b> </label>
                        <input type="text" class="form-control" name="sueldo_base" id="sueldo_base" placeholder="$" required number="true" campoNoVacio="true" />
                    </div>
                    <div class="col-md-4 form-group">
                        <label for="sueldo_total" class="titulo-dato"><span class="requeridos">* </span> <b> Sueldo total </b> </label>
                        <input type="text" class="form-control" name="sueldo_total" id="sueldo_total" placeholder="$" required number="true" campoNoVacio="true" />
                    </div>
                    <div class="col-md-4 form-group">
                        <label for="prima_quincenal" class="titulo-dato"><span class="requeridos">* </span> <b> Prima quincenal </b> </label>
                        <input type="text" class="form-control" name="prima_quincenal" id="prima_quincenal" placeholder="$" required number="true" campoNoVacio="true" />
                    </div>
                    <div class="col-md-4 form-group">
                        <label for="convenio" class="titulo-dato"> <b> Convenio </b> </label>
                        <input type="text" class="form-control normalizar-texto" name="convenio" id="convenio" placeholder="Ingresa convenio" />
                        <small>Si existe convenio ingreselo. Ejemplo: CONVENIO NO.848</small>
                    </div>
                    <div class="col-md-8 form-group">
                        <label for="descripcion_convenio" class="titulo-dato"> <b> Descripción convenio </b> </label>
                        <textarea rows="2" class="form-control normalizar-texto" name="descripcion_convenio" id="descripcion_convenio" ></textarea>
                    </div>
                </div>
            </div>
...
@push('scripts')
    ...
    <script src="{{ asset('js/p32_tramites_kardex/tareas/T03_generacionDocumentoTramiteKardexComprobantesServicio.js?ver=1.0') }}"></script>
    <script>
