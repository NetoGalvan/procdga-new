...
@section('subheader')
    @include('layouts.partials.main.subheader', ["subheader" => [
        "titulo_subheader" => "Notificaciones",
				...
				<table 
					...
					<thead>
						<tr>
							...
							<th data-field="tarea.nombre"><label class="titulo-dato">Notificación</label></th>
							<th data-field="instancia.folio"><label class="titulo-dato">Folio</label></th>
...
@push('scripts')
    <script>
        const urlGetTareas = @json(route("getTareas", ["NOTIFICACION", "REGISTROS"]));
    </script>
	<script src="{{ asset('metronic/plugins/custom/bootstraptable/js/bootstrap-table.min.js') }}"></script>
    <script src="{{ asset('metronic/plugins/custom/bootstraptable/js/bootstrap-table-es-SP.js') }}"></script>
    <script src="{{ asset('metronic/plugins/custom/momentjs/moment.min.js') }}"></script>
	<script src="{{ asset('js/general/tareas.js?v=1.8') }}"></script>
@endpush
