...
<form method="post" id="form1"
	action="{{route('seleccion.candidatos.guardar.notificaciones.rechazorios',$candidatoEstructura)}}"
	onsubmit="guardarDatosTablas(event)">
	<div class="row">
		<div class="col-md-12">
			<div class="alert alert-primary" role="alert">Se le notifica que los
				candidatos con RFC ha sido Rechazado</div>
		</div>
		<div class="col-md-12">
			<div class="card shadow-sm p-3 mb-5 bg-white rounded sinMargen">
				...
				<div class="card-body">
					...
					<div class="row " style="margin-bottom: 10px;">
						<div class="col-md-12 d-flex justify-content-center">
							<button type="submit" class="btn btn-success btn-sm" id="borrar">Enterado-
...
@push('scripts')
<script src="{{ asset('js/p11_seleccion_candidatos/TNOTA03.js') }}"></script>
@endpush
