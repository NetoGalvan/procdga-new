...
@section('contenido')
<h1 class="my-5 text-center titulo-tarea">Notificación: Validación de
	Candidatos a plaza de Personal de Estructura por parte del Secretario
	de Finanzas</h1>
		...
		<div class="card shadow-sm p-3 mb-5 bg-white rounded sinMargen"
			...
			<div class="card-body">
				<div class="alert alert-info" role="alert">
					...
					<p class="card-text">Unidad Administrativa :
...
<form method="post" id="form1"
	action="{{route('seleccion.candidatos.notificacion.rechazosGuardar',$candidatoEstructura)}}"
	...
	<div class="row">
		<div class="col-md-12 formu">
			<div class="card shadow-sm p-3 mb-5 bg-white rounded sinMargen"
				style="padding: 0px !important;">
				<div class="card-body">
					<h2 class="titulo-formulario">Validación de Candidatos</h2>
					<hr style="color: #0056b2;" />
					<div class="row">
						<div class="col-md-12">
							<div class="alert alert-primary" role="alert">¡RECUERDE! Si al
								menos uno de los candidatos fué validado, continúa con el
								proceso de evaluación.F</div>
						</div>
					</div>
...
@push('scripts')
<script src="{{ asset('js/p11_seleccion_candidatos/TNOTA04.js') }}"></script>
@endpush
