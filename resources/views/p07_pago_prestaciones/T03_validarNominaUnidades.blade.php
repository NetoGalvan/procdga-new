...
@section('title', 'Validar nómina de las unidades administrativas')
...
@section('subheader')
    @include('layouts.partials.main.subheader', ["subheader" => [
        ...
        "breadcrumbs" => [
            ...
            2 => [
                'activo' => true,
                'titulo' => 'Validar nómina de las unidades administrativas'
            ]
        ]
    ]])
@endsection
...
<form method="POST" action="{{route('pago.prestacion.validar.nomina', [$pagoPrestacion, $instanciaTarea])}}" id="form_finalizar_tarea">
	@csrf
...
@push('scripts')
	...
	<script src="{{ asset('js/p07_pago_prestaciones/T03_validarNominaUnidades.js') }}"></script>
@endpush
