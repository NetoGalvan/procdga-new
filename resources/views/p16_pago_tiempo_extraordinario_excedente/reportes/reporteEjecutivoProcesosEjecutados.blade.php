...
@section('title', 'PROCESOS EJECUTADOS PARA PAGO DE TIEMPO EXTRA Y EXCEDENTE')
...
@section('subheader')
    @include('layouts.partials.main.subheader', ["subheader" => [
        ...
        "breadcrumbs" => [
            ...
            2 => [
                'activo' => true,
                'titulo' => 'PROCESOS EJECUTADOS PARA PAGO DE TIEMPO EXTRA Y EXCEDENTE'
            ]
        ]
    ]])
@endsection
...
@section('contenido')
    ...
    <form action="{{ route('reporte.ejecutivo.procesos.ejecutados') }}" method="POST" id="reporte_ejecutivo_procesos_ejecutados">
        @method('post')
        @csrf
                ...
                <div class="alert alert-custom alert-success" role="alert">
                    ...
                    <div class="alert-text">
                        <strong>
                            ...
                            <ul class="mb-2">
                                <li>Ingrese la fecha del premio que desea consultar</li>
                            </ul>
                        </strong>
                    </div>
                </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table
                    ...
                    <thead>
                        <tr>
                            <th data-field="folio"><label class="titulo-dato">Horas Folio</label></th>
                            ...
                            <th data-field="fecha_limite"><label class="titulo-dato">Fecha límite</label></th>
                        </tr>
                    </thead>
                </table>
            </div>
...
@push('scripts')
    <script src="{{ asset('js/p16_pago_tiempo_extraordinario_excedente/reportes/reporteEjecutivoProcesosEjecutados.js') }}"></script>
    <script src="{{ asset('metronic/plugins/custom/bootstraptable/js/bootstrap-table.min.js') }}"></script>
    <script src="{{ asset('metronic/plugins/custom/bootstraptable/js/bootstrap-table-es-SP.js') }}"></script>
    <script>
        let urlReporteEmpleadosEjecutivoBuscar = @json( route('reporte.ejecutivo.procesos.ejecutados.buscar' ) );
        var urlReporteEjecutivoProcesosEjecutados = @json( route('descargar.pdf.reporte.ejecutivo.procesos.ejecutados' ) );
    </script>
@endpush
