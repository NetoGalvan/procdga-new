...
@section('title', "Personalizar formatos")

@section('subheader')
    @include('layouts.partials.main.subheader', ["subheader" => [
        "titulo_subheader" => "Personalizar formatos",
...
@section('aside_menu')
    @include('layouts.partials.main.aside_menu', ["asideMenu" =>
        [
            "item_seleccionado" => "admin.formatos",
        ]
    ])
@endsection
    ...
    <div class="col-md-5">
        <div class="card card-custom mb-8">
            ...
            <div class="card-footer">
                <button
                    data-url="{{ route("formatos.guardar.atributos") }}"
...
@push('scripts')
    ...
    <script src="{{ asset('js/administrador/formatos/index.js?v=1.0') }}"></script>
@endpush
