...
@section("titulo")
    <h4 class="centrado"> REPORTE ELECTRÓNICO DE PREMIO SEMESTRAL </h4>
@endsection

@section("contenido")
    <p class="letraCh">OP. AÑO QNA.: {{ $empleados[0]->nombre_quincena }} </p>
    <table class="table table-bordered table-general letraCh td" style="width:100%">
        <thead>
            <tr bgcolor="#E6E6E6">
                ...
                <td rowspan="2" class="centrado td">Área de adscripción</td>
        ...
        <tbody>
            @foreach ($empleados as $empleado)
                <tr>
                    ...
                    <td class="centrado td">{{ $empleado->created_by_bc_cn }}</td>
    ...
    <table class="letraMe" style="width:100%">
        <tbody>
            ...
            <tr>
                <td class="centrado">{{ $quienFirma->nombre }} {{ $quienFirma->apellido_paterno }} {{ $quienFirma->apellido_materno }}</td>
            </tr>
            <tr>
                <td class="centrado">{{ $quienFirma->puesto }}</td>
            </tr>
        </tbody>
    </table>
