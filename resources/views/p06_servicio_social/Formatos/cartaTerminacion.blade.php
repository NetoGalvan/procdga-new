...
<div class="mtn-20" style="font-family: Sans-serif;">
    ...
    <div class="font-size-13">
        <div class="text-right">
            ...
            ASUNTO: TERMINACIÓN DE {{ $servicioSocial->prestador->tipo_prestador ?? mb_strtoupper($servicioSocial->tipo_prestador)}} <br>
    ...
    <div class="font-size-12 text-justify">
        <p>
            ...
            en donde sus actividades realizadas fueron:
            <br><br>
            ...
            @if ( trim($servicioSocial->observaciones_carta_fin) != null)
                <br><br>
                Observaciones particulares: <br>
                {{ ucfirst( mb_strtolower($servicioSocial->observaciones_carta_fin) ) }}
            @endif
        </p>
    </div>
    <div class="font-size-13 text-center">
        ...
        <div>
            ...
            <table width="100%"  class="text-center">
                <tr>
                    <td>
                        {{$firmaCartaFin->nombre}} {{$firmaCartaFin->apellido_paterno}} {{$firmaCartaFin->apellido_materno}}
                    </td>
                </tr>
                <tr class="font-size-12">
                    <td><b>{{$firmaCartaFin->puesto}}</b></td>
                </tr>
                <tr class="font-size-12">
