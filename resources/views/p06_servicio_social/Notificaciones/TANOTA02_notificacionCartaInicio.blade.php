            ...
            <div class="card card-custom mb-5">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">Carta de inicio de {{ strtolower($servicioSocial->prestador->tipo_prestador) }} firmada</h3>
                    </div>
                </div>
                <div class="card-body">
...
--}}
    <form action="{{ route('servicio.social.notificacion.carta.aceptacion', [$servicioSocial, $instanciaTarea]) }}" method="post">
        @method('post')
        @csrf
{{--
        <div class="card card-custom mb-5">
...
--}}
        <div class="card card-custom mt-5">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <label class="titulo-dato">El candidato deberá presentarse para recoger la carta de aceptación en:</label>
                        <p>
