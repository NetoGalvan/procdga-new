<div class="card card-custom">
    ...
    <div class="card-body">
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#kt_tab_datos_escolares">
                <span class="nav-icon"><i class="fas fa-school"></i></span> Datos escolares
                </a>
            </li>
            @endif
            @if(in_array("prestacion_servicio", $secciones))
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#kt_tab_prestacion_servicio">
                <span class="nav-icon"><i class="fas fa-child"></i></span> Prestación del servicio
                </a>
            </li>
            @endif
        </ul>
        <div class="tab-content">
            <div class="tab-pane fade show active" id="kt_tab_datos_generales" role="tabpanel" aria-labelledby="kt_tab_datos_generales">
                ...
                <div class="row mt-5">
                    ...
                    @if(in_array("horas", $secciones['datos_candidato']))
                        ...
                        <div class="col-md-4">
                            <label class="titulo-dato">Horario que puede cubrir</label>
            ...
            @if(in_array("datos_escolares", $secciones))
                <div class="tab-pane fade" id="kt_tab_datos_escolares" role="tabpanel" aria-labelledby="kt_tab_datos_escolares">
                    <div class="row mt-5">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-2">
                            ...
                            <span class="valor-dato">  {{ $servicioSocial->prestador->matricula ?? 'S/D' }} </span>
                        </div>
                        <div class="col-md-6">
            ...
            @endif
            @if(in_array("prestacion_servicio", $secciones))
                <div class="tab-pane fade" id="kt_tab_prestacion_servicio" role="tabpanel" aria-labelledby="kt_tab_prestacion_servicio">
                    <div class="row mt-5">
                        <div class="col-md-4">
                            <label class="titulo-dato"> Área de adscripción </label>
                            <span class="valor-dato">  {{ $servicioSocial->areaAdscripcion->nombre_area_adscripcion ?? 'S/D' }} </span>
                        </div>
                        <div class="col-md-4">
                            <label class="titulo-dato"> Dirección ejecutiva (Dirección área) </label>
                            <span class="valor-dato">  {{ $servicioSocial->direccion_ejecutiva ?? 'S/D' }} </span>
                        </div>
                        <div class="col-md-4">
                            <label class="titulo-dato"> Coordinación </label>
                            <span class="valor-dato">  {{ $servicioSocial->coordinacion ?? 'S/D' }} </span>
                        </div>
                        <div class="col-md-4">
                            <label class="titulo-dato"> Subdirección </label>
                            <span class="valor-dato">  {{ $servicioSocial->subdireccion_ua ?? 'S/D' }} </span>
                        </div>
                        <div class="col-md-4">
                            <label class="titulo-dato"> Unidad Departamental </label>
                            <span class="valor-dato">  {{ $servicioSocial->unidad_departamental_ua ?? 'S/D' }} </span>
                        </div>
                        <div class="col-md-4">
                            <label class="titulo-dato"> Domicilio de adscripción </label>
                            <span class="valor-dato">  {{ $servicioSocial->areaAdscripcion->direccion_area_adscripcion ?? 'S/D' }} </span>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
    ...
    @if($servicioSocial->estatus === 'EN_CORRECCION')
    <div class="card-footer pt-2 pb-0">
        <div class="alert alert-custom alert-primary py-2 px-5" role="alert">
            <div class="alert-icon"><i class="flaticon-warning"></i></div>
            <div class="alert-text">
                  <strong>
                      <p class="mb-2">Correciones:</p>
                      {{$servicioSocial->correcciones ?? ''}}
                  </strong>
            </div>
        </div>
    </div>
