...
@section('subheader')
    @include('layouts.partials.main.subheader', ["subheader" => [
        ...
        "breadcrumbs" => [
            ...
            2 => [
                'activo' => true,
                'titulo' => 'REPORTE EJECUTIVO EXPEDIENTES DIGITALIZADOS EN EL PERIODO'
            ]
        ]
    ]])
@endsection
        ...
        <div class="card-body">
            <div class="alert alert-custom alert-success pb-0 pt-4" role="alert">
                ...
                <div class="alert-text">
                    ...
                    <p class="mt-5">Nota: Solo se mostraran los expedientes con archivos digitalizados</p>
                </div>
            </div>
            <form id="formBuscar">
            <div class="row mb-5">
            ...
            >
                <thead>
                    <tr>
                        ...
                        <th data-field="creado_por_nombre" class="w-20">
                            <label class="text-center titulo-dato">Creado por</label>
                        </th>
                        <th data-formatter="createdAtFormatter" class="text-center w-20">
                            <label class="titulo-dato">Fecha creación</label>
                        </th>
                    </tr>
                </thead>
            </table>
...
@push('scripts')
    <script type="text/javascript">
        URL_buscarExpedientes = "{{ route('reporte.ejecutivo.expedientes.digitalizados') }}";
        URL_descargarReporte = "{{ route('descargar.pdf.reporte.ejecutivo.expedientes.digitalizados') }}";
    </script>
    <script src="{{ asset('js/p23_digitalizacion_archivo/sweet_alert_general.js') }}"></script>
    <script src="{{ asset('js/p23_digitalizacion_archivo/reportes/reporteEjecutivoExpedientesDigitalizados.js') }}"></script>
