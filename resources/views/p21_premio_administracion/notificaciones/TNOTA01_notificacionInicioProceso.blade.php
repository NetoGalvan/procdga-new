...
@section('title', 'Notificación inicio de proceso')
    ...
    <div class="card card-custom mb-5">
        ...
        <div class="card-footer">
            <div class="text-center">
                <form action="{{ route('premio.administracion.notificacion.inicio.proceso', [$premioAdministracion, $instanciaTarea] ) }}" method="post" id="form_eliminar_notificacion">
                    @method('post') @csrf
                    <button id="btn_eliminar_notificacion" type="button" class="btn btn-success btn-md"> <i class="fas fa-trash"></i> Eliminar notificación</button>
                </form>
            </div>
        </div>
    </div>
