...
@section('title',  "Editar biométrico")
...
@section('contenido')
    <form action="{{ route("asistencia.catalogo.biometricos.update", $biometrico) }}" method="POST" id="form_guardar">
        @csrf
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">Editar biométrico</h3>
                </div>
            </div>
            <div class="card-body">
