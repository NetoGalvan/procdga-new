...
@section('contenido')
    <form id="form_buscar" action="{{ route('asistencia.reporte.tarjeta.electronica.buscar') }}">
    ...
    <div class="card card-custom mt-8">
        <div class="card-header">
            <div class="card-title">
                <h3 class="card-label">
                    Detalle de la tarjeta electrónica de asistencia
                </h3>
            </div>
        </div>
        <div class="card-body">
                ...
                <table
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-field="eventos_validos.ENTRADA" data-formatter="eventoValidoFormatter"><label class="titulo-dato">Entrada</label></th>
                            <th data-field="eventos_validos.RETARDO_LEVE" data-formatter="eventoValidoFormatter"><label class="titulo-dato">Retardo leve</label></th>
                            <th data-field="eventos_validos.RETARDO_GRAVE" data-formatter="eventoValidoFormatter"><label class="titulo-dato">Retardo Grave</label></th>
                            <th data-field="eventos_validos.SALIDA" data-formatter="eventoValidoFormatter"><label class="titulo-dato">Salida</label></th>
                            <th data-field="horario" data-formatter="horarioFormatter"><label class="titulo-dato">Horario de evaluación</label></th>
                            <th data-field="evaluacion_final" data-formatter="evaluacionFormatter"><label class="titulo-dato">Evaluación</label></th>
...
@push('scripts')
    ...
    <script src="{{ asset('js/p15_asistencia/reportes/tarjeta_electronica/index.js?v=1.8') }}"></script>
@endpush