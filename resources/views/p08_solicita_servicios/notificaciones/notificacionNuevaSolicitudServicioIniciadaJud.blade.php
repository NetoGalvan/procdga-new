...
@section('title', 'Notificación Solicitud de Servicio')
...
@section('subheader')
    @include('layouts.partials.main.subheader', ["subheader" => [
        ...
        "breadcrumbs" => [
            ...
            2 => [
                'activo' => true,
                'titulo' => 'Notificación Solicitud de Servicio'
            ]
        ]
    ]])
@endsection
...
@section('contenido')
    ...
    <form method="post" id="form_notificacion" action="{{ route('solicitud.servicio.notificacion.jud', [$solicitaServicio->p08_solicita_servicio_id, $instanciaTarea->instancia_tarea_id]) }}" >
        @method('post')
        @csrf
        ...
        <div class="card card-custom mb-5">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">Notificación - Solicitud de Servicio</h3>
                </div>
            </div>
            <div class="card-body">
                <div class="alert alert-custom alert-outline-success" role="alert">
                    ...
                    <div class="alert-text">
                        Solicitud de Servicio de <b> {{ $solicitaServicio->servicioGeneral->nombre_servicio_general }} </b> en proceso
                    </div>
                </div>
            </div>
        </div>
