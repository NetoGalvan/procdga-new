...
@section('title', 'Atención de Solicitud de Servicio')
...
@section('subheader')
    @include('layouts.partials.main.subheader', ["subheader" => [
        ...
        "breadcrumbs" => [
            ...
            2 => [
                'activo' => true,
                'titulo' => 'Atención de Solicitud de Servicio'
            ]
        ]
    ]])
@endsection
...
@section('contenido')
    ...
    <form method="POST" id="form_notificacion" action="{{ route('solicitud.servicio.notificacion.aceptada.jud', [$solicitaServicio, $instanciaTarea]) }}">
        @method('post')
        @csrf
        ...
        <div class="card card-custom mb-5">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">Notificación - Atención de Solicitud de Servicio</h3>
                </div>
            </div>
            <div class="card-body">
        ...
        <div class="card card-custom mb-5">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">Entregables para el servicio solicitado</h3>
                </div>
            </div>
            <div class="card-body">
