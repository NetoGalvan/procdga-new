...
@section('title', 'REPORTE EJECUTIVO INCENTIVO EMPLEADO DEL MES')
...
@section('subheader')
    @include('layouts.partials.main.subheader', ["subheader" => [
        ...
        "breadcrumbs" => [
            ...
            2 => [
                'activo' => true,
                'titulo' => 'REPORTE EJECUTIVO INCENTIVO EMPLEADO DEL MES'
            ]
        ]
    ]])
@endsection
...
@section('contenido')
    ...
    <form action="{{ route('reporte.ejecutivo.incentivo.empleado.mes') }}" method="POST" id="reporte_incentivo_empleado_mes">
        @method('post')
        @csrf
                ...
                <div class="alert alert-custom alert-success" role="alert">
                    ...
                    <div class="alert-text">
                        <strong>
                            ...
                            <ul class="mb-2">
                                <li>Ingrese la fecha del premio de incentivo empleado del mes que desea consultar</li>
                            </ul>
                        </strong>
                    </div>
                </div>
    ...
    <div class="card card-custom mt-8">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table
                    id="tabla_incentivo_empleado_mes"
                    class="text-center"
                    data-toggle="table"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-field="nombre_quincena"><label class="titulo-dato">Quincena</label></th>
                            <th data-field="estatus" data-formatter="estatusFormatter"><label class="titulo-dato">Estatus</label></th>
                            <th data-field="area_creadora" data-formatter="areaFormatter"><label class="titulo-dato">Área Creadora</label></th>
                            <th data-field="fechas" data-formatter="fechasFormatter"><label class="titulo-dato">Fechas</label></th>
                            <th data-field="subprocesos" data-formatter="subprocesosFormatter"><label class="titulo-dato">Subprocesos</label></th>
                            <th data-field="empelados" data-formatter="empleadosFormatter"><label class="titulo-dato">Empleados</label></th>
                        </tr>
                    </thead>
                </table>
            </div>
...
@push('scripts')
    <script src="{{ asset('js/p19_incentivos_empleado_mes/reportes/reporteEjecutivoIncentivoEmpleadoMes.js') }}"></script>
    <script src="{{ asset('metronic/plugins/custom/bootstraptable/js/bootstrap-table.min.js') }}"></script>
    <script src="{{ asset('metronic/plugins/custom/bootstraptable/js/bootstrap-table-es-SP.js') }}"></script>
    <script>
        let urlIncentivoEmpleadoMesBuscar = @json( route('reporte.ejecutivo.incentivo.empleado.mes.buscar') );
        let urlIncentivoEmpleadoMesDescargar = @json( route('reporte.ejecutivo.incentivo.empleado.mes.descargar') );
    </script>
@endpush
